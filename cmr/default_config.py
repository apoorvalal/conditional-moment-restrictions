...
methods = {
    ...
    "GEL": {
        ...
        "hyperparams": {"divergence": ["chi2", "kl", "log"], "reg_param": [0, 1e-6]},
    },
    "MMR": {
        "estimator_kwargs": {"kernel_z_kwargs": {}},
        "hyperparams": {},
    },
    "SMD": {"estimator_kwargs": {}, "hyperparams": {}},
    "DeepIV": {"estimator_kwargs": {}, "hyperparams": {}},
    "VMM-kernel": {
...
kmm_hyperparams = {
    "n_reference_samples": [200],  # [0, 100, 200, 400],
...
for config_id, hparam in enumerate(iterate_argument_combinations(kmm_hyperparams)):
    ...
    estimator_kwargs.update(
        {
            "theta_optim_args": {"optimizer": "oadam_gda", "lr": hparam["theta_lr"][0]},
        }
    )
